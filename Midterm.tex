...
analysis We used R {[}Version 3.5.2; @{]} and the R-packages
\emph{data.table} (Version 1.12.0; Brown, 2004), \emph{pwr} (Version
1.2.2; Mehr, 2014), and \emph{summarytools} (Version 0.9.2; Samuel A.
Mehr \& Spelke, 2016) for all our analyses.
